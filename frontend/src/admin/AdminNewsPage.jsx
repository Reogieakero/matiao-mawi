...
const NEWS_CATEGORIES = [
    'Public Advisory', 'Emergency Alert', 'Community Activity', 
    'Health Advisory', 'Events', 'Ordinances / Resolutions', 
    'Disaster Response Update', 'Other'
];
...
// Function to get a color for the news category tag (Used in Cards and Modals)
            ...
            <div style={baseViewModalStyles.modal}>
                ...
                <div style={baseViewModalStyles.contentGrid}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
                        ...
                        {/* THE 'CREATED ON' SECTION HAS BEEN REMOVED HERE */}
...
const NewsFormModal = ({ show, initialData, onClose, onSave }) => {
    const [formData, setFormData] = useState({
        ...
        attachments: [], // Array of file objects for upload, or URLs for display
    });
    ...
    useEffect(() => {
        if (show) {
            ...
            if (initialData) {
                ...
                setFormData({
                    title: '', category: NEWS_CATEGORIES[0], content: '', featured_image_url: '',
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const url = initialData ? `${API_BASE_URL}/admin/news/${initialData.id}` : `${API_BASE_URL}/admin/news`;
            ...
            setError(err.message || 'An error occurred while saving the news item.');
        } finally {
            setLoading(false);
        }
    };
    ...
    // Corrected Inline Styles definition
            ...
            <div style={styles.modal}>
                ...
                <form onSubmit={handleSubmit} style={styles.form}>
                    ...
                    <div style={styles.inputGroup}>
                        <label style={styles.label}>1. News Title *</label>
                        <input
                            type="text" name="title" value={formData.title}
                            onChange={handleChange} style={styles.input} required
                            placeholder="e.g., Barangay Clean-Up Drive Schedule"
                        />
                    </div>
                    
                    <div style={styles.inputGroup}>
                        <label style={styles.label}>3. Content / Detailed Description *</label>
                        <textarea
                            name="content" value={formData.content}
                            onChange={handleChange} style={styles.textarea} required
                            placeholder="Provide the full explanation, schedules, or procedures here."
                        />
                    </div>
...
const AdminNewsPage = () => {
    ...
    const handleDeleteNews = async (id) => {
        if (!window.confirm("Are you sure you want to ARCHIVE this news item? It will be removed from public view.")) {
            return;
        }
        try {
            ...
            setMessageModal({
                show: true,
                title: 'Success!',
                body: 'News item successfully archived.',
                isSuccess: true
            });
            fetchNews(); 
        } catch (err) {
            setMessageModal({
                show: true,
                title: 'Error',
                body: 'Failed to archive news item.',
                isSuccess: false
            });
            console.error(err);
        }
    ...
    if (loading) {
        return <div style={styles.pageContainer}>Loading news...</div>;
    }
        ...
        <div style={styles.pageContainer}>
            ...
            <div style={styles.controls}>
                <div style={styles.searchInput}>
                    ...
                    <input
                        type="text"
                        placeholder="Search news (title, category, content...)"
                        value={searchTerm}
