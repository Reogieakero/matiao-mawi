...
export default function RightPanel({ userName, userEmail }) {
  ...
  const officialList = [
    { id: 1, name: "John Doe", position: "Barangay Captain", profileLink: "/profile", status: "On Duty" },
    { id: 2, name: "Jane Smith", position: "Council Member", profileLink: "/profile", status: "On Leave" },
    { id: 3, name: "Mark Johnson", position: "Health Officer", profileLink: "/profile", status: "Busy" },
    { id: 4, name: "Emily Davis", position: "Secretary", profileLink: "/profile", status: "On Duty" },
    { id: 5, name: "Michael Brown", position: "Treasurer", profileLink: "/profile", status: "Offline" },
    { id: 6, name: "Sarah Wilson", position: "Youth Leader", profileLink: "/profile", status: "On Leave" },
    { id: 7, name: "David Lee", position: "Barangay Tanod", profileLink: "/profile", status: "On Duty" },
    { id: 8, name: "Anna Taylor", position: "Senior Citizen Rep", profileLink: "/profile", status: "Busy" },
    { id: 9, name: "Chris Evans", position: "Environmental Officer", profileLink: "/profile", status: "On Duty" },
  ];
